...
--              VALUES ('test',(select '2022-09-09T15:45:00.559339'::timestamp),(SELECT CAST ('this is the description...' AS TEXT)),pg_read_binary_file('D:\Data\NOVI\eindopdracht\backend-eindopdracht\fassignment\src\main\assets\The_Fiddler_Marc_Chagall.png'),(select '2022-09-09 15:45:00.559339'::timestamp),'test','cobergfell');

INSERT INTO public.paintings ("artist","date_time_posted","description","image","last_update","title","username")
              VALUES ('test',(select '2022-09-09T15:45:00.559339'::timestamp),'this is the description...',pg_read_binary_file('D:\Data\NOVI\eindopdracht\backend-eindopdracht\fassignment\src\main\assets\The_Fiddler_Marc_Chagall.png'),(select '2022-09-09 15:45:00.559339'::timestamp),'test','cobergfell');
...
INSERT INTO public.music_files_database ("bytes_in_database_url","data","description","file_on_disk_id","file_on_disk_url","name","type","answer_id","painting_id","question_id")
              VALUES (NULL,lo_from_bytea(0,pg_read_binary_file('D:\Data\NOVI\eindopdracht\backend-eindopdracht\fassignment\src\main\assets\rachmaninov.mp3')),NULL,2,'http://localhost:8080/api/user/download-file-from-disk/2','rachmaninov.mp3','audio/mpeg',NULL,1,NULL);
INSERT INTO public.music_files_database ("bytes_in_database_url","data","description","file_on_disk_id","file_on_disk_url","name","type","answer_id","painting_id","question_id")
              VALUES (NULL,lo_from_bytea(0,pg_read_binary_file('D:\Data\NOVI\eindopdracht\backend-eindopdracht\fassignment\src\main\assets\Gurdjieff_by_Jeroen_van_Veen.mp3')),NULL,4,'http://localhost:8080/api/user/download-file-from-disk/5','Gurdjieff_by_Jeroen_van_Veen.mp3','audio/mpeg',NULL,1,NULL);
